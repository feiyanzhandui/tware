...
object LogregMllib {
  ...
  def main(args: Array[String]) {
    ...
    val model1 = LogisticRegressionWithSGD.train(parsedData, ITER, 1.0, 1.0)

    val start = System.nanoTime()
    val model2 = LogisticRegressionWithSGD.train(parsedData, ITER, 1.0, 1.0)
